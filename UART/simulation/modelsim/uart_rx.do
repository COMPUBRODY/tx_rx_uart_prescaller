...
vlog -vlog01compat -work work +incdir+C:/Users/Madera/Documents/Quartus_Workspace/tx_rx_uart_prescaller-master/UART/tb_module {C:/Users/Madera/Documents/Quartus_Workspace/tx_rx_uart_prescaller-master/UART/tb_module/tb_uart_rx.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  tb_uart_rx
