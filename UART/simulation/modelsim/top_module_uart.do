...
vlog -vlog01compat -work work +incdir+C:/Users/Madera/Documents/Quartus_Workspace/tx_rx_uart_prescaller-master/UART/tb_module {C:/Users/Madera/Documents/Quartus_Workspace/tx_rx_uart_prescaller-master/UART/tb_module/tb_top_module_uart.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  tb_top_module_uart

add wave *

add wave -position end sim:/tb_top_module_uart/tb_top_module_uart_DUT/u1/*
add wave -position end sim:/tb_top_module_uart/tb_top_module_uart_DUT/u5/*
add wave -position end sim:/tb_top_module_uart/tb_top_module_uart_DUT/u4/*
view structure
view signals
run -all
